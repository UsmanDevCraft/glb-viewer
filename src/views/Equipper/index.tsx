...
function AvatarScene({
  ...
  // Merge sources: preview > explicit glbAssets > defaults
  const final = {
    body: preview?.body || glbAssets.body || defaults.body,
    head: glbAssets.head || defaults.head,
    hair: preview?.hair || glbAssets.hair || defaults.hair,
    shirt: preview?.shirt || glbAssets.shirt || defaults.shirt,
    pants: preview?.pants || glbAssets.pants || defaults.pants,
    shoes: preview?.shoes || glbAssets.shoes || defaults.shoes,
    bodyColorTexture:
